...
export default class Label extends PureComponent {
  ...
  render() {
    ...
    //absolute positioning seems to mess up the parent padding and doesn't take it into account in react-native. here we pass it in again.
